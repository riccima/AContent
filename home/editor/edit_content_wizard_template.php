...
// Inserire una chiamata a DB per lettura valore su campo structure e poi azzera il suddetto campo
define("PATH", "../../include/");
require_once(PATH.'classes/DAO/ContentDAO.class.php');
$sql = "SELECT structure FROM ".TABLE_PREFIX."content 
...
<div class="input-form" style="width: 95%;">
        ...
        <div style=" weight: 10%; margin: 10px 0px 0px 10px;"><?php echo _AT('wizard_template_title'); ?></div>
        <div style="padding:5px;"></div>
        <input type="hidden" value="<?php echo $_POST['title']; ?>" >
        <div id="lab_back" name="<?php echo $_course_id; ?>"><label id="l_back" class="button_back" name="<?php echo $cid; ?>">Back</label></div>
<?php if ($changes_made): ?>
		<div class="unsaved">
...
<script>
    $('table[class="etabbed-table"]').remove();
</script>